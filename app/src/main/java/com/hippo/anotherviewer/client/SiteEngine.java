...
public class SiteEngine {
    ...
    public static String signIn(@Nullable SiteClient.Task task, OkHttpClient okHttpClient,
    ...
    private static void fillGalleryList(@Nullable SiteClient.Task task, OkHttpClient okHttpClient, List<GalleryInfo> list, String url, boolean filter) throws Throwable {
    ...
    public static GalleryListParser.Result getGalleryList(@Nullable SiteClient.Task task, OkHttpClient okHttpClient,
    ...
    public static List<GalleryInfo> fillGalleryListByApi(@Nullable SiteClient.Task task, OkHttpClient okHttpClient,
    ...
    private static void doFillGalleryListByApi(@Nullable SiteClient.Task task, OkHttpClient okHttpClient,
                                               List<GalleryInfo> galleryInfoList, String referer) throws Throwable {
...
//    https://e-hentai.org/g/2914213/fc8bce61d9/
    ...
    public static Pair<PreviewSet, Integer> getPreviewSet(
            @Nullable SiteClient.Task task, OkHttpClient okHttpClient, String url) throws Throwable {
        String referer = SiteUrl.getReferer();
        Log.d(TAG, url);
        Request request = new SiteRequestBuilder(url, referer).build();
        Call call = okHttpClient.newCall(request);
    ...
    public static RateGalleryParser.Result rateGallery(@Nullable SiteClient.Task task,
    ...
    public static GalleryCommentList commentGallery(@Nullable SiteClient.Task task,
    ...
    public static String getGalleryToken(@Nullable SiteClient.Task task, OkHttpClient okHttpClient,
    ...
    public static FavoritesParser.Result getFavorites(@Nullable SiteClient.Task task, OkHttpClient okHttpClient,
     ...
     */
    public static Void addFavorites(@Nullable SiteClient.Task task, OkHttpClient okHttpClient,
    ...
    public static Void addFavoritesRange(@Nullable SiteClient.Task task, OkHttpClient okHttpClient,
    ...
    public static FavoritesParser.Result modifyFavorites(@Nullable SiteClient.Task task, OkHttpClient okHttpClient,
    ...
    public static TorrentInfo[] getTorrentList(@Nullable SiteClient.Task task, OkHttpClient okHttpClient,
    ...
    public static SiteTopListDetail getTopList(@Nullable SiteClient.Task task, OkHttpClient okHttpClient,
                                             String url) throws Throwable {
...
//        Request request = new SiteRequestBuilder(url, referer).build();
    ...
    public static Pair<String, Pair<String, String>[]> getArchiveList(@Nullable SiteClient.Task task, OkHttpClient okHttpClient,
                                                                      String url, long gid, String token) throws Throwable {
        String referer = SiteUrl.getGalleryDetailUrl(gid, token);
        Log.d(TAG, url);
        Request request = new SiteRequestBuilder(url, referer).build();
    ...
    public static ArchiverData getArchiver(@Nullable SiteClient.Task task, OkHttpClient okHttpClient,
                                           String url, long gid, String token) throws Throwable {
        String referer = SiteUrl.getGalleryDetailUrl(gid, token);
        Log.d(TAG, url);
        Request request = new SiteRequestBuilder(url, referer).build();
    ...
    public static Void downloadArchive(@Nullable SiteClient.Task task, OkHttpClient okHttpClient,
    ...
    public static String downloadArchiver(
            @Nullable SiteClient.Task task, OkHttpClient okHttpClient, String url, String referer, String dltype, String dlcheck)
            throws Throwable {
...
//            获取跳转链接
    ...
    private static ProfileParser.Result getProfileInternal(@Nullable SiteClient.Task task,
    ...
    public static ProfileParser.Result getProfile(@Nullable SiteClient.Task task,
    ...
    public static VoteCommentParser.Result voteComment(@Nullable SiteClient.Task task, OkHttpClient okHttpClient,
     ...
     */
    public static GalleryListParser.Result imageSearch(@Nullable SiteClient.Task task, OkHttpClient okHttpClient,
    ...
    public static GalleryPageParser.Result getGalleryPage(@Nullable SiteClient.Task task,
    ...
    public static GalleryPageApiParser.Result getGalleryPageApi(@Nullable SiteClient.Task task,
    ...
    public static UserTagList getWatchedList(@Nullable SiteClient.Task task,
...
//        return SiteNewsParse.parse("");
    ...
    public static HomeDetail getHomeDetail(@Nullable SiteClient.Task task, OkHttpClient okHttpClient) throws Throwable {
        String referer = SiteUrl.getReferer();
    ...
    public static HomeDetail resetLimit(@Nullable SiteClient.Task task, OkHttpClient okHttpClient) throws Throwable {
        FormBody.Builder builder = new FormBody.Builder();
