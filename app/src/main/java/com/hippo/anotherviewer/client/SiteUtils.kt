...
object SiteUtils {
    ...
    private val CATEGORY_VALUES = intArrayOf(
        SiteConfig.MISC,
        SiteConfig.DOUJINSHI,
        SiteConfig.MANGA,
        SiteConfig.ARTIST_CG,
        SiteConfig.GAME_CG,
        SiteConfig.IMAGE_SET,
        SiteConfig.COSPLAY,
        SiteConfig.ASIAN_PORN,
        SiteConfig.NON_H,
        SiteConfig.WESTERN,
        UNKNOWN
    )
    ...
    fun getCategoryColor(category: Int): Int {
        when (category) {
            SiteConfig.DOUJINSHI -> return BG_COLOR_DOUJINSHI
            SiteConfig.MANGA -> return BG_COLOR_MANGA
            SiteConfig.ARTIST_CG -> return BG_COLOR_ARTIST_CG
            SiteConfig.GAME_CG -> return BG_COLOR_GAME_CG
            SiteConfig.WESTERN -> return BG_COLOR_WESTERN
            SiteConfig.NON_H -> return BG_COLOR_NON_H
            SiteConfig.IMAGE_SET -> return BG_COLOR_IMAGE_SET
            SiteConfig.COSPLAY -> return BG_COLOR_COSPLAY
            SiteConfig.ASIAN_PORN -> return BG_COLOR_ASIAN_PORN
            SiteConfig.MISC -> return BG_COLOR_MISC
    ...
    fun signOut(context: Context) {
        SiteApplication.getSiteCookieStore(context).signOut()
    ...
    fun needSignedIn(context: Context): Boolean {
        return Settings.getNeedSignIn() && !SiteApplication.getSiteCookieStore(context).hasSignedIn()
    }
