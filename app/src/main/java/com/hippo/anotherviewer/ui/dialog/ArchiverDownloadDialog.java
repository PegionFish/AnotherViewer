...
import static com.hippo.anotherviewer.client.SiteConfig.ARCHIVER_PATH;

import static com.hippo.anotherviewer.ui.scene.BaseScene.LENGTH_LONG;

import static com.hippo.anotherviewer.ui.scene.BaseScene.LENGTH_SHORT;
...
public class ArchiverDownloadDialog implements
        ...
        DialogInterface.OnDismissListener, SiteClient.Callback<ArchiverData> {
    ...
    public void showDialog() {
        ...
        SiteRequest mRequest = new SiteRequest().setMethod(SiteClient.METHOD_ARCHIVER)
    ...
    private void onArchiverDownload(View view) {
        ...
        try {
            ...
            if (null != context && null != activity && galleryDetail != null) {
                ...
                request.setMethod(SiteClient.METHOD_DOWNLOAD_ARCHIVER);
    ...
    public void onSuccess(ArchiverData result) {
        ...
        if (Settings.getGallerySite() == SiteUrl.SITE_E) {
    ...
    private class DownloadArchiverListener extends SiteCallback<GalleryDetailScene, String> {
