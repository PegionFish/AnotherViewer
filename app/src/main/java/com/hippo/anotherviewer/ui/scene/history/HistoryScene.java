...
package com.hippo.anotherviewer.ui.scene.history;
...
public class HistoryScene extends ToolbarScene
    ...
    private void updateLazyList() {
        LazyList<HistoryInfo> lazyList = SiteDB.getHistoryLazyList();
        if (mLazyList != null) {
            mLazyList.close();
        }
        mLazyList = lazyList;
    ...
    private class HistoryAdapter extends RecyclerView.Adapter<HistoryHolder>
        ...
        public void onBindViewHolder(HistoryHolder holder, int position) {
            ...
            if (!newCategoryText.equals(category.getText())) {
                ...
                category.setBackgroundColor(SiteUtils.getCategoryColor(gi.category));
            }
    ...
    private static class addToFavoriteListener extends SiteCallback<HistoryScene, Void> {
