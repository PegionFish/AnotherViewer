...
import com.hippo.anotherviewer.ui.scene.GalleryHolder;
import com.hippo.anotherviewer.ui.scene.TransitionNameFactory;
import com.hippo.anotherviewer.widget.TileThumb;
...
abstract class GalleryAdapter extends RecyclerView.Adapter<GalleryHolder> {
    ...
    public GalleryAdapter(@NonNull LayoutInflater inflater, @NonNull Resources resources,
        ...
        mDownloadManager = SiteApplication.getDownloadManager(inflater.getContext());
    }
    ...
    public void onBindViewHolder(@NonNull GalleryHolder holder, int position) {
        ...
        switch (mType) {
            ...
            case TYPE_GRID: {
                ...
                int color = SiteUtils.getCategoryColor(gi.category);
