...
import static com.hippo.anotherviewer.client.SiteConfig.IMAGE_SIZE_780X;
import static com.hippo.anotherviewer.client.SiteConfig.IMAGE_SIZE_980X;
...
public class Settings {
    ...
    private static SiteConfig sSiteConfig;
    ...
    private static SiteConfig loadSiteConfig() {
        SiteConfig ehConfig= new SiteConfig();
...
//        }
    ...
    public static final int DEFAULT_DEFAULT_CATEGORIES = SiteUtils.ALL_CATEGORY;
    ...
    public static void putDefaultCategories(int value) {
        sSiteConfig.defaultCategories = value;
        sSiteConfig.setDirty();
    ...
    public static void putExcludedTagNamespaces(int value) {
        sSiteConfig.excludedNamespaces = value;
        sSiteConfig.setDirty();
    ...
    public static void putExcludedLanguages(String value) {
        sSiteConfig.excludedLanguages = value;
        sSiteConfig.setDirty();
    ...
    public static final String DEFAULT_IMAGE_RESOLUTION = SiteConfig.IMAGE_SIZE_AUTO;
    ...
    public static void putImageResolution(String value) {
        if(null==value||null==sSiteConfig){
            return;
        }
        sSiteConfig.imageSize = value;
        sSiteConfig.setDirty();
    ...
    private static final boolean DEFAULT_BETA_UPDATE_CHANNEL = SiteApplication.BETA;
    ...
    private static final boolean DEFAULT_SAVE_PARSE_ERROR_BODY = SiteApplication.BETA;
    ...
    private static final int DEFAULT_PROXY_TYPE = SiteProxySelector.TYPE_SYSTEM;
